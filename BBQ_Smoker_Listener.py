"""
    This program listens and consumes messages from bbq_producer
    for the temperature of the smoker every 30 seconds. It send
    an alert if the smoker temperature decreases by more than 15 degrees in a 2.5 min period. 
...
alert = "Alert! Alert! Alert! Smoker temperature has decreased by 15 degrees in the last 2.5 min."
